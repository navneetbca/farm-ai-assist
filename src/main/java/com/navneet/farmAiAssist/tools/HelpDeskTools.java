...
import com.navneet.farmAiAssist.service.HelpDeskTickerService;
...
public class HelpDeskTools {
    ...
    private final HelpDeskTickerService helpDeskTickerService;
    ...
    String createTicket(@ToolParam(description = "Details to create a Support ticket")
        ...
        HelpDeskTicket savedTicket = helpDeskTickerService.createTicket(ticketRequest,username);
    ...
    List<HelpDeskTicket> getTicketStatus(ToolContext toolContext) {
        ...
        List<HelpDeskTicket> tickets =  helpDeskTickerService.getTicketsByUsername(username);
